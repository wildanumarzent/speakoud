...
class EvaluasiPengajarSheet implements
    FromView,
    WithEvents,
    WithTitle
{
    ...
    protected $mata, $bahan, $detail, $pg, $essay, $value;

    public function __construct($mata, $bahan, $detail, $pg, $essay, $value)
    {
        $this->mata = $mata;
        $this->bahan = $bahan;
        $this->detail = $detail;
    ...
    public function view(): View
    {
        ...
        if ($this->value === 'PG') {
            return view('frontend.course.evaluasi.export.pengajar-sheet-1', [
                'mata' => $mata,
                'bahan' => $bahan,
                'detail' => $detail,
                'pg' => $pg
            ...
            return view('frontend.course.evaluasi.export.pengajar-sheet-2', [
                'mata' => $mata,
                'bahan' => $bahan,
                'detail' => $detail,
                'essay' => $essay
