...
class Peserta extends Component
{
    ...
    public function mount(MataPelatihan $mata, MataPeserta $peserta,ProgramPelatihan $program){
    ...
    public function render()
    {
        ...
        $peserta = $this->peserta->whereIn('mata_id',$mataId)->count();
        $colors = $color[$section][array_rand($color[$section])];
        $chart->addSlice($a->judul,$peserta, $colors);
        }
        return view('livewire.chart.peserta',compact('chart'));
    }
}
