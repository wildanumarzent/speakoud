...
class LogTime extends Component
{
    ...
    public $log,$date;
    public function mount(Log $log,$date){
        $this->log = $log;
        $this->date = $date;
    }
    public function render()
    {
        ...
        $logTime = $this->log->whereDate('created_at',$this->date)->get()->groupBy(function($date) {
            return Carbon::parse($date->created_at)->format('Y-m-d H:i'); // grouping by date
            });
        $chart = (new ColumnChartModel());
        // $chart->withoutDataLabels();
        $chart->withoutLegend();
        foreach($logTime as $a => $date){
