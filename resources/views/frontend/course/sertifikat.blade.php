    ...
    @if ($data['read']->bobot->bobotActivity($data['read']->id, auth()->user()->id) == 10)
        ...
        <h6 class="font-weight-semibold mb-4">Sertifikat</h6>
            ...
            <div class="card mb-2">
                ...
                <a class="d-flex justify-content-between text-body collapsed" data-toggle="collapse" href="#sertifikat-internal" aria-expanded="false">
                    <strong>Sertifikat Internal</strong>
                    <div class="collapse-icon"></div>
                </a>
                </div>
                <div id="sertifikat-internal" class="collapse" data-parent="#accordion2" style="">
                <div class="card-body">
            ...
            <div class="card mb-2">
                <div class="card-header">
                <a class="d-flex justify-content-between text-body collapsed" data-toggle="collapse" href="#sertifikat-external" aria-expanded="false">
                    <strong>Sertifikat External</strong>
                    <div class="collapse-icon"></div>
                </a>
                </div>
                <div id="sertifikat-external" class="collapse" data-parent="#accordion2" style="">
                <div class="card-body">
                    <ul class="list-group list-group-flush mt-2">
