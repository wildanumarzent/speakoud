...
<div class="text-left">
    ...
    <a href="{{ route('evaluasi.penyelenggara.export', ['id' => $data['mata']->id]) }}" class="btn btn-success rounded-pill" title="export data evaluasi"><i class="las la-file-excel"></i>Export</a>
    @endif
</div>
<br>
