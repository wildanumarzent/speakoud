...
<div class="card">
    ...
    <form action="{{ route('template.quiz.item.store', ['id' => $data['quiz']->id, 'tipe' => Request::get('tipe')]) }}" method="POST">
        @csrf
        <div class="card-body">
        ...
        <div class="card-footer">
            <div class="row">
              <div class="col-md-10 ml-sm-auto text-md-left text-right">
                <a href="{{ route('template.quiz.item', ['id' => $data['quiz']->id]) }}" class="btn btn-danger" title="klik untuk kembali ke list" data-toggle="tooltip">Kembali</a>
