...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        ...
        <input type="text" id="file_path" class="form-control @error('file_path') is-invalid @enderror" name="file_path" value="{{ isset($data['bahan']) ? old('file_path', $data['bahan']->audio->bankData->file_path) : old('file_path') }}" placeholder="Pilih audio dari bank data..." readonly onclick="openFm()">
