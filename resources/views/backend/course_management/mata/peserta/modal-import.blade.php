<div class="modal fade" id="modals-import">
    <div class="modal-dialog">
      <form class="modal-content" action="{{ route('mata.peserta.import', ['id' => $data['mata']->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-header">
          <h5 class="modal-title">
            Import
            <span class="font-weight-light">Data Peserta</span>
            <br>
        ...
        <div class="modal-body">
          ...
          <div class="form-row">
            <div class="form-group col">
              ...
              <a href="{{ url('userfile/excel/peserta-program.xlsx') }}" class="btn btn-sm btn-outline-success mt-3"><i class="las la-file-excel mr-2"></i> Download Contoh file Excel</small></a>
            </div>
          </div>
        </div>
