<div class="modal fade" id="modals-import">
    <div class="modal-dialog">
      <form class="modal-content" action="{{ route('mata.instruktur.import', ['id' => $data['mata']->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-header">
          <h5 class="modal-title">
            Import
            <span class="font-weight-light">Data Instruktur</span>
            <br>
        ...
        <div class="modal-body">
            <div class="alert alert-warning alert-dismissible">
                ...
                Pastikan data instruktur yang akan di import <strong>sudah tersedia di aplikasi & belum tersedia di enroll program ini</strong>
            </div>
          <div class="form-row">
            <div class="form-group col">
              ...
              <a href="{{ url('userfile/excel/instruktur-program.xlsx') }}" class="btn btn-sm btn-outline-success mt-3"><i class="las la-file-excel mr-2"></i> Download Contoh file Excel</small></a>
            </div>
          </div>
        </div>
