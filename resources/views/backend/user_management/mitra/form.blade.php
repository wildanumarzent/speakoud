            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-1">
                            <a href="{{ route('instansi.mitra.create') }}" class="btn btn-primary icon-btn" title="klik untuk menambah instansi"><i class="las la-plus"></i></a>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-2 text-md-right">
                        ...
                        <div class="col-md-10">
                          <input type="text" class="form-control @error('kedeputian') is-invalid @enderror" name="kedeputian"
                            value="{{ (isset($data['mitra'])) ? old('kedeputian', $data['mitra']->kedeputian) : old('kedeputian') }}" placeholder="masukan unit kerja...">
                    ...
                    {{-- <div class="form-group row">
                        ...
                        <div class="col-md-10">
                          <input type="text" class="form-control @error('pangkat') is-invalid @enderror" name="pangkat"
                            value="{{ (isset($data['mitra'])) ? old('pangkat', $data['mitra']->pangkat) : old('pangkat') }}" placeholder="masukan Jabatan...">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select class="status custom-select form-control" name="pangkat">
                                ...
                                <option value="{{ $key }}" {{ isset($data['mitra']) ? (old('pangkat', $data['mitra']->pangkat) == ''.$key.'' ? 'selected' : '') : (old('pangkat') == ''.$key.'' ? 'selected' : '') }}>{{ $value }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('phone') is-invalid @enderror" name="phone"
                                    value="{{ (isset($data['mitra'])) ? old('phone', $data['mitra']->user->information->phone) : old('phone') }}" placeholder="masukan nomor telpon...">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                          <textarea class="form-control @error('alamat') is-invalid @enderror" name="address" placeholder="masukan alamat...">{{ (isset($data['mitra'])) ? old('address', $data['mitra']->user->information->address) : old('address') }}</textarea>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-10 ml-sm-auto text-md-left text-right">
                        <a href="{{ route('mitra.index') }}" class="btn btn-danger" title="klik untuk kembali ke list">Kembali</a>
                        <button type="submit" class="btn btn-primary" name="action" value="save" title="klik untuk menyimpan">{{ isset($data['mitra']) ? 'Simpan perubahan' : 'Simpan' }}</button>
                    </div>
                </div>
            </div>
        </form>
