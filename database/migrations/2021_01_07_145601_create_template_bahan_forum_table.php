...
class CreateTemplateBahanForumTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('template_bahan_forum', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('limit_topik')->nullable();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('template_bahan_forum');
    }
}
