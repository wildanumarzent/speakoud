...
class CreateTemplateBahanAudioTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('template_bahan_audio', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('template_bahan_audio');
    }
}
